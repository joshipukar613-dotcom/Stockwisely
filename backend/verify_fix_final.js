...
async function run() {
    ...
    try {
        ...
        SELECT 
          COUNT(*) FILTER (WHERE ls.balance_qty <= COALESCE(p.min_stock_level, 5) AND ls.balance_qty > 0)::bigint AS low_stock,
          COUNT(*) FILTER (WHERE ls.balance_qty = 0)::bigint AS out_of_stock,
